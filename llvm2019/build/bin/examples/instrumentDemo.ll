...
@.str.3 = private unnamed_addr constant [107 x i8] c"Hello, you are running an instrumented binary.\0APerformance may vary while running an instrumented binary.\0A\00", align 1
...
define dso_local void @_Z10__initMaini(i32) #2 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([107 x i8], [107 x i8]* @.str.3, i32 0, i32 0))
  ret void
}
...
!0 = !{!"clang version 8.0.0 (tags/RELEASE_800/final 362767)"}
